    ...
    constructor(props) {
        ...
        this.state = {
            data: [
                {
                    id: 1,
                    filmImg: 'https://upload.wikimedia.org/wikipedia/en/thumb/c/c4/Kill_Bill_Volume_2.png/220px-Kill_Bill_Volume_2.png',
                    filmTitle: 'Kill Bill',
                    filmGenre: 'Drama',
                    filmYear: 1995,
                    filmDuration: 154,
                    filmSummary: 'A former assassin, known simply as The Bride (Uma Thurman), wakes from a coma four years after her jealous ex-lover Bill (David Carradine) attempts to murder her on her wedding day. Fueled by an insatiable desire for revenge, she vows to get even with every person who contributed to the loss of her unborn child, her entire wedding party, and four years of her life. After devising a hit list, The Bride sets off on her quest, enduring unspeakable injury and unscrupulous enemies.',
                    filmRating: 4.5
                },
                {
                    id: 2,
                    filmImg: 'https://m.media-amazon.com/images/M/MV5BMDQ4MGY0NWUtY2MxOC00YzI5LTg0OTEtZjNmY2Q2ZmM0MTA1XkEyXkFqcGdeQXVyNTQzOTc3MTI@._V1_.jpg',
                    filmTitle: 'Legend',
                    filmGenre: 'Biography, Crime, Drama',
                    filmYear: 2015,
                    filmDuration: 132,
                    filmSummary: 'Suave, charming and volatile, Reggie Kray (Tom Hardy) and his unstable twin brother Ronnie start to leave their mark on the London underworld in the 1960s. Using violence to get what they want, the siblings orchestrate robberies and murders while running nightclubs and protection rackets. With police Detective Leonard "Nipper" Read hot on their heels, the brothers continue their rapid rise to power and achieve tabloid notoriety.',
                    filmRating: 4.1
                },
            ],
        ...
        return (
            <>
                <Header
                    ...
                    filmsData={this.state.data}
                    searchButtonHandler={this.onSearchButtonClick.bind(this)}
                    onSearchLinkClick={this.onSearchLinkClick.bind(this)}/>
                {this.state.isFilmSearched ? (
                    <Main filmsData={this.state.data}
                          selectedGenre={this.state.selectedGenre}
                          sortBy={this.state.sortBy}
                          isFilmSelected={this.state.selectedFilmId}
