...
const Header = (props) => {
  const { selectedFilmId, filmsData, searchButtonHandler, onSearchLinkClick } = props;
  return (
      <header className="header py-4 mb-2">
          <div className="container">
              ...
              { selectedFilmId ?  (
                  <HeaderSelected selectedFilm={filmsData.filter((item) => item.id === +selectedFilmId)[0]} onSearchLinkClick={onSearchLinkClick}/>
              ) : (
